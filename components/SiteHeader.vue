...
defineProps({
  ...
  themeColor: { type: String, default: '#ffc200' },
...
onMounted(() => {
  ...
  if (typeof window !== 'undefined') {
    hasSeenIntro.value = !!sessionStorage.getItem('hasSeenIntro')
  }
})
</script>
...
.druk-title { 
  ...
  /* Add this to add "fake" weight */
  -webkit-text-stroke: 1px currentColor; 
}
.btn-text { position: relative; display: inline-block; }

/* Slide animation for non-index pages */
