  ...
  <Transition :name="isIndex ? '' : 'slide-up'">
    ...
    >
      ...
      <div class="relative z-10 w-full h-full flex items-start justify-between px-[27px] pt-[16px] md:pt-[20px]">
        ...
        <div class="absolute left-1/2 logo-center-nudge top-[11px] md:top-[23px] h-[40px] flex items-center justify-center pointer-events-auto">
...
/* Custom class for the 2px left nudge */
